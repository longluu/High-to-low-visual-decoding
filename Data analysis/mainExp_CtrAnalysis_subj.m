...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_1back);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_1back);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_2back);
sem_p_2 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_2back);
sem_p_3 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_3back);
sem_p_2 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_3back);
sem_p_3 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_4back);
sem_p_2 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_4back);
sem_p_3 = nanstd(bootstat);
...
% %% Plot the results for all back cumulative (add up individual effects)
...
% sem_p_2back_cum_sum = nanstd(p_crossTrial_2back_cum_sum) / sqrt(length(p_crossTrial_2back_cum_sum));
% mean_p_3back_cum_sum = nanmedian(p_crossTrial_3back_cum_sum);
% sem_p_3back_cum_sum = nanstd(p_crossTrial_3back_cum_sum) / sqrt(length(p_crossTrial_3back_cum_sum));
% mean_p_4back_cum_sum = nanmedian(p_crossTrial_4back_cum_sum);
% sem_p_4back_cum_sum = nanstd(p_crossTrial_4back_cum_sum) / sqrt(length(p_crossTrial_4back_cum_sum));
% 
% figure
% hold on
% plot([0 5], [1 1], '--k')
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_2back_cum);
sem_p_2 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_2back_cum);
sem_p_3 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_3back_cum);
sem_p_2 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_3back_cum);
sem_p_3 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond2_4back_cum);
sem_p_2 = nanstd(bootstat);
...
bootstat = bootstrp(nBootstrap,@nanmedian, p_crossTrial_Cond3_4back_cum);
sem_p_3 = nanstd(bootstat);
