function plot_model_sampling_marginalized(estimate_cond1, estimate_cond2, theta, pthetahGtheta_1, pthetahGtheta_2, axis_project, pProject_1, pProject_2, ...
...
[est_hist_cond1, est_hist_cond2] = ...
        make_2dhistogram(estimate_cond1, estimate_cond2, [], [], [], smooth_sampling, edge_bin, h_filter);    
...
pDiff = pDiff / (sum(pDiff) * diff(x_pDiff(1:2)));
plot(x_pDiff, pDiff, 'b', 'LineWidth', lineWidth)
% Marginalized
